...
class ControlPanel:
    ...
    def setRemoteFormParts(self):
        ...
        self.__video_quality_radio_button_1080 = tk.Radiobutton(self.__video_quality_radio_frame, image = self.__1080_img, variable = self.__video_quality_value, value = 137, indicatoron = False, borderwidth = 0, command = self.changeVideoQualityImg)
        ...
        self.__video_quality_radio_button_720 = tk.Radiobutton(self.__video_quality_radio_frame, image = self.__720_img, variable = self.__video_quality_value, value = 136, indicatoron = False, borderwidth = 0, command = self.changeVideoQualityImg)
        ...
        self.__video_quality_radio_button_480 = tk.Radiobutton(self.__video_quality_radio_frame, image = self.__480_img, variable = self.__video_quality_value, value = 135, indicatoron = False, borderwidth = 0, command = self.changeVideoQualityImg)
        ...
        self.__video_quality_radio_button_360 = tk.Radiobutton(self.__video_quality_radio_frame, image = self.__360_img, variable = self.__video_quality_value, value = 134, indicatoron = False, borderwidth = 0, command = self.changeVideoQualityImg)
        ...
        self.__video_quality_radio_button_240 = tk.Radiobutton(self.__video_quality_radio_frame, image = self.__240_img, variable = self.__video_quality_value, value = 133, indicatoron = False, borderwidth = 0, command = self.changeVideoQualityImg)
        ...
        self.__video_quality_radio_button_144 = tk.Radiobutton(self.__video_quality_radio_frame, image = self.__144_img, variable = self.__video_quality_value, value = 160, indicatoron = False, borderwidth = 0, command = self.changeVideoQualityImg)
    ...
    def setLocalFormParts(self):
        ...
        self.__audio_quality_radio_button_44100 = tk.Radiobutton(self.__audio_quality_radio_frame, image = self.__44100_img, variable = self.__audio_quality_value, value = 44100, indicatoron = False, borderwidth = 0, command = self.changeAudioQualityImg)
        ...
        self.__audio_quality_radio_button_32000 = tk.Radiobutton(self.__audio_quality_radio_frame, image = self.__32000_img, variable = self.__audio_quality_value, value = 32000, indicatoron = False, borderwidth = 0, command = self.changeAudioQualityImg)
        ...
        self.__audio_quality_radio_button_16000 = tk.Radiobutton(self.__audio_quality_radio_frame, image = self.__16000_img, variable = self.__audio_quality_value, value = 16000, indicatoron = False, borderwidth = 0, command = self.changeAudioQualityImg)
    ...
    def setTrainTestFormParts(self):
        ...
        self.__train_radio_button = tk.Radiobutton(self.__train_radio_frame, image = self.__train_img, variable = self.__train_value, value = 1, indicatoron = False, borderwidth = 0, command = self.changeTrainTestImg)
        ...
        self.__test_radio_button = tk.Radiobutton(self.__train_radio_frame, image = self.__test_img, variable = self.__train_value, value = 0, indicatoron = False, borderwidth = 0, command = self.changeTrainTestImg)
